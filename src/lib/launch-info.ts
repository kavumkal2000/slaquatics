export const LAUNCH_ADDRESS = 'Point Vista Rd, Hickory Creek, TX 75065, United States';
export const LAUNCH_ADDRESS_LINES = ['Point Vista Rd', 'Hickory Creek, TX 75065', 'United States'] as const;
