...
const sharedFieldSchema: Record<string, CmsFieldSchema> = {
  ...
  packages: { control: 'collection', itemFields: ['id', 'label', 'description', 'displayPrice', 'bookingPath', 'badge', 'includes'] },
  offerings: { control: 'collection', itemFields: ['id', 'title', 'copy', 'price', 'badge', 'image', 'buttons'] },
  metrics: { control: 'collection', itemFields: ['label', 'value', 'caption'] },
  steps: { control: 'collection', itemFields: ['label', 'title', 'copy'] },
  valueProps: { control: 'collection', itemFields: ['title', 'copy', 'image'] },
...
export const cmsSlaquaticsSiteConfig = createCmsSiteConfig({
  ...
  blocks: [
    ...
    { type: 'rental-offering-cards', label: 'Rental Offering Cards', category: 'business', fields: ['heading', 'copy', 'offerings'], fieldSchema: blockSchema(['copy', 'offerings']) },
    { type: 'rental-product-cards', label: 'Rental Product Cards', category: 'business', fields: ['heading', 'items'] },
    { type: 'rental-package-builder', label: 'Rental Package Builder', category: 'business', fields: ['heading', 'copy', 'packages', 'pricingSource'], fieldSchema: blockSchema(['copy', 'packages']) },
    ...
    { type: 'rental-waiver-checklist', label: 'Rental Waiver Checklist', category: 'business', fields: ['termsVersion', 'heading', 'copy', 'checkboxes', 'signatureFields', 'legalItems'], fieldSchema: blockSchema(['copy', 'checkboxes', 'signatureFields', 'legalItems']) },
    ...
    { type: 'local-service-area-page', label: 'Local Service Area Page', category: 'business', fields: ['city', 'driveTime', 'routeCopy', 'localFaq', 'nearbyCities', 'canonicalHref', 'smsPrefill', 'proofItems'], fieldSchema: blockSchema(['routeCopy', 'localFaq', 'nearbyCities', 'canonicalHref', 'smsPrefill', 'proofItems']) },
    ...
    { type: 'review-summary-carousel', label: 'Review Summary Carousel', category: 'business', fields: ['heading', 'score', 'summary', 'sources', 'reviews'], fieldSchema: blockSchema(['score', 'summary', 'sources', 'reviews']) },
    ...
    { type: 'rental-policy-cards', label: 'Rental Policy Cards', category: 'business', fields: ['heading', 'copy', 'policies'], fieldSchema: blockSchema(['copy', 'policies']) },
    ...
    { type: 'seasonal-rental-offer', label: 'Seasonal Rental Offer', category: 'business', fields: ['offerKey', 'startsAt', 'endsAt', 'eligibleDates', 'eligibleCraft', 'allowedDurations', 'headline', 'body', 'ctaHrefTemplate', 'priority', 'status'], fieldSchema: blockSchema(['eligibleDates', 'eligibleCraft', 'allowedDurations', 'body', 'priority']) },
    { type: 'trust-metric-bar', label: 'Trust Metric Bar', category: 'business', fields: ['heading', 'copy', 'metrics'], fieldSchema: blockSchema(['copy', 'metrics']) },
    { type: 'rental-process-steps', label: 'Rental Process Steps', category: 'business', fields: ['heading', 'copy', 'steps'], fieldSchema: blockSchema(['copy', 'steps']) },
    { type: 'value-prop-grid', label: 'Value Prop Grid', category: 'business', fields: ['heading', 'copy', 'valueProps'], fieldSchema: blockSchema(['copy', 'valueProps']) },
