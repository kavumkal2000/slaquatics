...
export const metadata: Metadata = {
  ...
  description: "Looking for a jet ski rental near Denton? Book Shoreline Aquatics at Point Vista Rd, Hickory Creek, TX 75065, United States on Lake Lewisville, open daily 10 AM-8 PM.",
