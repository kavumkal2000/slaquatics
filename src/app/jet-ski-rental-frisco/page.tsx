...
export const metadata: Metadata = {
  ...
  description: "Searching for a jet ski rental near Frisco? Book Shoreline Aquatics at Point Vista Rd, Hickory Creek, TX 75065 on Lake Lewisville, open daily 10 AM-8 PM.",
